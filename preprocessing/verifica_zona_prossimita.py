# QUESTO È UN ALTRO SCRIPT DI PREPROCESSING PER VERIFICARE LA PRESENZA E IL VALORE DEGLI ELEMENTI <data-inizio> E <zona-prossimita> NELL'XML
# ALLA FINE ABBIAMO DECISO DI USARE ZONA DI PROSSIMITÀ E NON DATA DI INIZIO PER LA CREAZIONE DELLE PAGINE HTML PERCHÈ LA
# DATA NON ERA SEMPRE VALORIZZATA E SOPRATTUTTO AVREBBE POTUTO CREARE QUALCHE PROBLEMA IN FASE DI GENERAZIONE DELLE PAGINE HTML.
# ABBIAMO PREFERITO SCLUDERE DATA E SUCCESSIVAMENTE ANCHE COORDINATE PER POSSIBILI PROBLEMI DI FORMATTAZIONE DEI DATI (GIÀ INCONTRATI IN PASSATO)
